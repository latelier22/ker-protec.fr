...
const Navbar = () => {
  ...
  return (
    <nav
      className="relative flex w-full items-center justify-between bg-sky-600 py-2 text-white shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:bg-black dark:text-gold-500 md:flex-wrap"
      data-te-navbar-ref
    >
      <div className="flex w-full  items-center  px-3">
        <a href="/" className="ml-2">
          <img src={site.logo.url} className="h-12 w-auto" alt="Accueil" />
        </a>
